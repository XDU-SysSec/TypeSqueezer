...
tar -xzvf main.zip
cd FSROPT-main/typearmor-master
. ./envsetup.sh
cd di-opt
make
cd ../static
...
ln -s ../FSROPT-main/typearmor-master/run-ta-static.sh .
ln -s ../FSROPT-main/typearmor-master/envsetup.sh .
ln -s ../FSROPT-main/typearmor-master/server-bins .
ln -s ../FSROPT-main/typearmor-master/out FSROPT-out
